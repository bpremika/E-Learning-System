...
exports.createCourseMaterial =
    exports.createAssignment =
    exports.createCourseVideo =
    exports.updateAssignment =
    exports.updateCourseVideo =
    exports.updateDescCourse =
    exports.getDetailedDashboard =
        void 0;
const prisma_1 = require("../common/prisma");
const CourseValidator_1 = require("../common/CourseValidator");
const getDetailedDashboard = (req, res) =>
    __awaiter(void 0, void 0, void 0, function* () {
        ...
        if (course.instructor_id != req.session.userID) {
            res.status(404).send({
                message: "This course not contain this ID",
            });
            return;
        }
...
const updateDescCourse = (req, res) =>
    __awaiter(void 0, void 0, void 0, function* () {
        const id = parseInt(req.params.id);
        if (isNaN(id)) {
            res.status(404).send({ message: "invalid ID" });
        ...
        const check =
            CourseValidator_1.updateDescCourseSchema.safeParse(newCourseDto);
        if (check.success) {
...
const updateCourseVideo = (req, res) =>
    __awaiter(void 0, void 0, void 0, function* () {
        const id = parseInt(req.params.id);
        if (isNaN(id)) {
            res.status(404).send({ message: "invalid ID" });
        ...
        const check =
            CourseValidator_1.updateCourseVideoSchema.safeParse(newVideoDto);
        if (check.success) {
            const course_check_id = yield prisma_1.prisma.course.findUnique({
                where: { id },
            });
...
const updateAssignment = (req, res) =>
    __awaiter(void 0, void 0, void 0, function* () {
        ...
        const check =
            CourseValidator_1.updateAssignmentSchema.safeParse(newAssignment);
        if (check.success) {
            const course_check_id = yield prisma_1.prisma.course.findUnique({
                where: { id },
            });
...
const createCourseVideo = (req, res) =>
    __awaiter(void 0, void 0, void 0, function* () {
        const id = parseInt(req.params.id);
        if (isNaN(id)) {
            res.status(404).send({ message: "invalid ID" });
        ...
        const check =
            CourseValidator_1.createCourseVideoSchema.safeParse(courseVideo);
        if (check.success) {
            const course_check_id = yield prisma_1.prisma.course.findUnique({
                where: { id },
            });
...
const createAssignment = (req, res) =>
    __awaiter(void 0, void 0, void 0, function* () {
        ...
        const check =
            CourseValidator_1.createAssignmentSchema.safeParse(assignment);
        if (check.success) {
            const course_check_id = yield prisma_1.prisma.course.findUnique({
                where: { id },
            });
...
const createCourseMaterial = (req, res) =>
    __awaiter(void 0, void 0, void 0, function* () {
        ...
        const result =
            CourseValidator_1.courseMaterialSchema.safeParse(material);
        if (result.success) {
            try {
