...
exports.courseSchema = zod_1.z.object({
    ...
    course_detail: zod_1.z.string(),
    course_cover_url: zod_1.z.string(),
    guide_url: zod_1.z.string(),
    instructor_id: zod_1.z.number().int().positive(),
    max_student: zod_1.z.number().int().refine(isPositiveOrMinusOne),
    curr_student: zod_1.z.number().int().positive(),
});
